...
-   **<span style="font-size: 20px;">Daniel Koch</span>**
...
-   ![](assets/aaron_brown.jpg){ width=200px }

    **<span style="font-size: 20px;">Aaron Brown</span>**

    **Degree**: MS Mechanical Engineering

-   ![](assets/david_christensen.png){ width=200px }

    **<span style="font-size: 20px;">David Christensen</span>**

    **Degree**: MS Mechanical Engineering

-   **<span style="font-size: 20px;">Jaron Ellingson</span>**

    **Degree**: PhD Mechanical Engineering

-   **<span style="font-size: 20px;">Coulton Karch</span>**
...
-   **<span style="font-size: 20px;">Alex Jordan</span>**

    **Degree**: MS Mechanical Engineering

-   ![](assets/brendon_forsgren.jpg){ width=200px }

    **<span style="font-size: 20px;">Brendon Forsgren</span>**

    **Degree**: PhD Mechanical Engineering

-   ![](assets/jake_johnson.jpg){ width=200px }

    **<span style="font-size: 20px;">Jake Johnson</span>**
...
-   ![](assets/thane_downing.png){ width=200px }

    **<span style="font-size: 20px;">Thane Downing</span>**

    **Degree**: MS Electrical and Computer Engineering

    **Email**: downing2@byu.edu

-   ![](assets/tanner_norton.jpeg){ width=200px }

    **<span style="font-size: 20px;">Tanner Norton</span>**

    **Degree**: MS Computer Science

    **Email**: tannort5@byu.edu

-   **<span style="font-size: 20px;">Doug Graff</span>**
...
-   **<span style="font-size: 20px;">Jared Moore</span>**
...
-   **<span style="font-size: 20px;">Jacob Olson</span>**

    **Degree**: MS Mechanical Engineering

-   **<span style="font-size: 20px;">Gary Ellingson</span>**

    **Degree**: PhD Mechanical Engineering

-   **<span style="font-size: 20px;">James Jackson</span>**

    **Degree**: PhD Mechanical Engineering

-   **<span style="font-size: 20px;">Michael Farrell</span>**

    **Degree**: MS Mechanical Engineering

-   **<span style="font-size: 20px;">Puneet Jain</span>**

    **Degree**: MS Electrical and Computer Engineering

-   **<span style="font-size: 20px;">Skyler Tolman</span>**
...
-   ![](assets/david_wheeler.jpeg){ width=200px }

    **<span style="font-size: 20px;">David Wheeler</span>**
...
-   **<span style="font-size: 20px;">Travis Millet</span>**
...
-   ![](assets/david_casbeer.jpeg){ width=200px }

    **<span style="font-size: 20px;">David Casbeer</span>**
...
-   ![](assets/andrew_curtis.jpeg){ width=200px }

    **<span style="font-size: 20px;">Andrew Curtis</span>**
...
-   ![](assets/jared_yates.jpeg){ width=200px }

    **<span style="font-size: 20px;">Jared Yates</span>**

    **Degree**: BS Electrical Engineering

-   ![](assets/neil_johnson.jpeg){ width=200px }

    **<span style="font-size: 20px;">Neil Johnson</span>**
...
-   ![](assets/josh_matthews.jpeg){ width=200px }

    **<span style="font-size: 20px;">Josh Matthews</span>**
...
-   **<span style="font-size: 20px;">Jisang Sun</span>**
...
-   ![](assets/steve_griffiths.jpeg){ width=200px }

    **<span style="font-size: 20px;">Steve Griffiths</span>**
...
-   **<span style="font-size: 20px;">Jason Vest</span>**

    **Degree**: MS Mechanical Engineering

    **Email**: jvest@et.byu.edu

-   ![](assets/wei_ren.jpeg){ width=200px }

    **<span style="font-size: 20px;">Wei Ren</span>**
...
-   ![](assets/joshua_hintze.jpeg){ width=200px }
    ...
    **<span style="font-size: 20px;">Joshua Hintze</span>**
...
-   **<span style="font-size: 20px;">David Walker</span>**
...
-   ![](assets/peter_jones.jpeg){ width=200px }
    ...
    **<span style="font-size: 20px;">Peter Jones</span>**
...
-   **<span style="font-size: 20px;">J. Willard Curtis</span>**
...
-   ![](assets/jed_kelsey.jpeg){ width=200px }
...
-   **<span style="font-size: 20px;">Sujit P.B.</span>**
